...
dataset = pd.read_excel(
    'data\\aggregated_dataset_in_'+str(n_per_in)+'_out_'+str(n_per_out)+'.xlsx',
    header=0,
    engine='openpyxl',
    index_col='date'
)
...
# model = ensemble.RandomForestRegressor(criterion="mae", n_estimators=50, max_depth=10)
